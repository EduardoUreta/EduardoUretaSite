...
fetch('https://rickandmortyapi.com/api/character')
    ...
    .then((data) => {
        ...
        const personajesHTML = personajeRickMorty.map(personaje => {
            return `
            <div class="col-lg-6 col-md-12 col-sm-12 card m-auto m-0 justify-content-center text-center mt-5 animate__animated">
                <div class="license-card" data-aos="fade-up" data-aos-delay="100">
                    ...
                    <div class="card-body d-flex flex-column flex-md-row align-items-center">
                        ...
                        <div class="info-section w-100 w-md-75 ms-md-4 text-start text-md-left">
